...
EditText   txt_name,  txt_email,txt_feedback;
TextView txt_suggest,txt_lang;
...
Fragment fragment;
	 ...
	 public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 txt_feedback = (EditText) rootView.findViewById(R.id.txt_feedback);
     ...
     public class Myclass extends AsyncTask<Void, Void, Void>
       {
		...
		protected Void doInBackground(Void... params) {
			...
			String  suggest  = txt_feedback.getText().toString();
			String  Email =txt_email.getText().toString();
			
			HttpClient client = new DefaultHttpClient();
			HttpPost post = new HttpPost("http://tapnknow.esy.es/email.php");
			List<NameValuePair> pairs = new ArrayList<NameValuePair>();
			pairs.add(new BasicNameValuePair("sugest", suggest));
